...
class ProductGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Product entity")
        ...
        .repeat(2) {
            ...
            .post("/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "companyId":"SAMPLE_TEXT", "manager":"SAMPLE_TEXT", "categoryId":"SAMPLE_TEXT", "code":"SAMPLE_TEXT", "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "price":null, "active":null, "activationDate":"2020-01-01T00:00:00.000Z", "deactivationDate":"2020-01-01T00:00:00.000Z", "schema":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
